...
Textarea.prototype._listener = function(ch, key) {
  ...
  if (key.name === 'left' && this.value.length) {
    ...
    this.key_pressed.width = this._getPrevGlyphWidth(this.screen.fullUnicode, this.value, this.caret);
  } else if (key.name === 'right' && this.value.length) {
    this.key_pressed.key = 'right';
    this.key_pressed.width = this._getNextGlyphWidth(this.screen.fullUnicode, this.value, this.caret);
  }
  ...
  if (key.name === 'escape') {
    ...
    if (this.value.length) {
      ...
      var width = this._getPrevGlyphWidth(this.screen.fullUnicode, this.value, this.caret);
