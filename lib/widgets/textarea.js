...
Textarea.prototype._updateCursor = function(get) {
  ...
  if (this.key_pressed.key === 'up' || this.key_pressed.key === 'down') {
    if (this.key_pressed.key === 'up') {
      this.cursor = this._getCoordsAfterUp(this._clines, this.cursor);
    } else if (this.key_pressed.key === 'down') {
  ...
  } else if (this.key_pressed.key !== null) {
...
Textarea.prototype._listener = function(ch, key) {
  ...
  if (key.name === 'left' && this.value.length) {
    ...
    this.key_pressed.width = this._getNextGlyphWidth(this.screen.fullUnicode,
                                                     this.value,
                                                     this.caret);
  } else if (key.name === 'up' && this.value.length) {
    this.key_pressed.key = 'up';
  } else if (key.name === 'down' && this.value.length) {
    this.key_pressed.key = 'down';
  }
